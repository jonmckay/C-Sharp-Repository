...
namespace The_Quest
{
    class Game
    {
        // Keeps up with players, weapons, and a list of enemies
        // There's only one weapon per level, so the game just needs a
        // Weapon reference, not a List. The Player, however, has a
        // List<Weapon> to hold the inventory
        ...
        public void NewLevel(Random random)
        {
            ...
            switch (level)
            {
                ...
                case 7:
                    ...
                    Enemies.Add(new Ghost(this, GetRandomLocation(random)));
                    Enemies.Add(new Ghoul(this, GetRandomLocation(random)));
                    if (CheckPlayerInventory("Mace") && !CheckPlayerInventory("RedPotion"))
                    {
                        WeaponInRoom = new RedPotion(this, GetRandomLocation(random));
                    }
                    else
