...
namespace Basic_Dictionary_Chapter_8
{
    public partial class DictionaryForm : Form
    {
        ...
        {
            JerseyNumber jerseryNumber = retiredNumbers[(int)cbNumber.SelectedItem] as JerseyNumber;
            lblPlayer.Text = jerseryNumber.Player;
            lblYearRetired.Text = jerseryNumber.YearRetired.ToString();
        }
    }
}
